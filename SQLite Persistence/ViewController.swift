...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(self.applicationWillResignASctive(notification:)), name: UIApplication.willResignActiveNotification, object: app)
    }
    ...
    @objc func applicationWillResignASctive(notification:NSNotification) {
        var database: OpaquePointer? = nil
